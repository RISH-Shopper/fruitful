  ...
  if (state.cartOrder.order) {
    ...
    for (let i = 0; i < arrayOfProducts.length; ++i) {
      ...
      finalArr.push({
        ...
        quantity: currentProduct.productQuantityObj.quantity,
        unitPrice: currentProduct.productQuantityObj.product.price
      })
    }
    return finalArr
  }
  ...
  if (state.cartOrder.order) {
    ...
    for (let i = 0; i < arrayOfProducts.length; ++i) {
      ...
      finalArr.push({
        orderId: orderId,
        productId: +currentProduct.productId,
        title: currentProduct.productQuantityObj.product.title,
        quantity: currentProduct.productQuantityObj.quantity,
        unitPrice: currentProduct.productQuantityObj.product.price
      })
    }
